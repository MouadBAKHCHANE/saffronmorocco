...
export default function OriginMap() {
  const t = useT();
  return (
    <section className="bg-[#030501] min-h-[90vh] flex items-center py-20 md:py-24 overflow-hidden">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.25fr] gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-5 max-w-2xl">
            ...
            <FadeUp delay={0.4}>
              <div className="relative group overflow-hidden bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-sm">
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-xs md:text-sm leading-relaxed font-light max-w-sm">
