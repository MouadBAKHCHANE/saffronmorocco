            ...
            <div className="space-y-3">
              ...
              <FadeUp delay={0.1}>
                <h2 className="font-headline text-4xl md:text-6xl font-light text-off-white leading-[0.9] tracking-tight whitespace-nowrap">
                  Taliouine, <span className="italic font-light text-primary">Morocco</span>
                </h2>
              </FadeUp>
            ...
            <FadeUp delay={0.3}>
              <div className="grid grid-cols-2 gap-4 border-y border-outline-variant/10 py-4">
                <div className="group/metric">
                  <h5 className="text-sm text-primary uppercase tracking-[0.3em] font-bold mb-1.5 group-hover/metric:translate-x-1 transition-transform">Crocine</h5>
                  <p className="text-xs uppercase tracking-widest text-on-surface-variant mb-1">Tinting Strength</p>
                  <p className="text-sm text-stone-500 leading-snug font-light">
                    Record-high concentrations verified by Grade I ISO standards.
                  </p>
                </div>
                <div className="group/metric">
                  <h5 className="text-sm text-primary uppercase tracking-[0.3em] font-bold mb-1.5 group-hover/metric:translate-x-1 transition-transform">Safranal</h5>
                  <p className="text-xs uppercase tracking-widest text-on-surface-variant mb-1">Aromatic profile</p>
                  <p className="text-sm text-stone-500 leading-snug font-light">
                    Deep fragrance profile perfected at 1,500m altitude.
                  </p>
                </div>
              </div>
            </FadeUp>
            ...
            <FadeUp delay={0.4}>
              <div className="relative group overflow-hidden bg-surface-container-low/30 backdrop-blur-md border border-outline-variant/20 p-5 rounded-sm">
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-headline text-xl md:text-2xl italic mb-2">Terroir of Excellence</h4>
