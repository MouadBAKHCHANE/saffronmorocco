import { alternatesFor, withLocale } from "@/i18n/routing";
...
/**
 * Rendered at /products and, via the [locale] re-export, at /fr|es/products.
 * Server component, so it reads the locale from params rather than the client
 * context — otherwise its in-page links would send French visitors to English.
 */
